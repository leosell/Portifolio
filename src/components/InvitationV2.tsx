...
//                   onClick={() => { alert("pagina para enquete e lista de presente") }}
//                 >
//                   Confirmar
//                 </button>
//               </div>
...
//               {!convite ? (
//                 <>
//                   <h2 className="text-xl font-bold mb-4">Confirme sua presença</h2>
...
//                   <h2 className="text-xl font-bold mb-4">🎉 Presença confirmada!</h2>
//                   <p>{convite?.nome}, você já confirmou sua presença.</p>
//                 </div>
//               )}
//             </div>
//           </div>
